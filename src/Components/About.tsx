      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
          <div className="flex justify-center">
            <a href="/Amenity-Map-4.0.pdf">
              <figure className="mb-4 ">
                <img
                  className="w-full mt-4 rounded-lg border-2 "
                  src="/poa-map.jpg"
                  alt=" voyager village amenity map"
                  style={{ maxWidth: 600 }}
                />
                <figcaption style={{ maxWidth: 600 }}>
                  Voyager Village offers many amenities to its owners. Shown
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <p className="">
              Nestled in the heart of cabin country, Voyager Village is located
              in northwest Wisconsin near Jackson and Webber. It is a short two
              hour drive from the Minneapolis/St.Paul metro area.
            </p>
            <div className="flex flex-wrap">
              ...
              <div className="sm:max-w-xl md:mt-5 lg:mx-0">
                ...
                <p>
                  Burnett county is home to 59 miles of Summer ATV Trails and 97
                ...
                <p>
                  There are many subdivisions in Voyager Village. These maps
                  will provide a guide to the area. Also be sure to check out
